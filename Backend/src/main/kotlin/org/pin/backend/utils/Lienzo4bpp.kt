...
class Lienzo4bpp(
    ...
    fun getPixel(x: Short, y: Short): Int {
        val index = y * width + x
    ...
    private fun setPixel(x: Short, y: Short, color: Byte) {
    ...
    fun drawLine(p1: PointDeltaDTO, p2: PointDeltaDTO) {
        val dx = p2.x - p1.x
        val dy = p2.y - p1.y
    ...
    private fun drawCircle(cx: Int, cy: Int, radius: Int, color: Byte) {
